...
public class Order {
    ...
    public Order(int id, List<OrderLine> orderLineList, LocalDate creationDate, BigDecimal totalPrice,
    ...
    public Order(int id, OrderStatus orderStatus, LocalDate creationDate, BigDecimal totalPrice,
                 PaymentMethod paymentMethod, LocalDate deliveryDueDate, User user, String description,
